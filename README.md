...
![](https://github.com/user-attachments/assets/dbf4406d-fb4e-4a6a-960c-a5d127ff65f1)
...
In order for the app to fully work, you will need to allow notifications for the app (either through system settings or when the app first boots up).
